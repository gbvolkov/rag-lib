...
"""
E2E Example 16A: HTML -> HTML Segments + Dual Retrieval

Features Tested:
1. HTMLLoader in strict html output mode.
2. HTMLSplitter in html mode with hierarchy-aware segmentation and table row chunking.
...
def main() -> None:
    setup_environment()
    print_section("16A. HTML -> HTML Dual Retrieval Workflow")
    ...
    save_json_results(docs, "16_html_html", "loaded_documents")

    print_section("2. Parent Segmentation (HTML mode)")
    ...
    save_json_results(parent_segments, "16_html_html", "parent_segments")
    ...
    save_json_results(child_segments, "16_html_html", "child_segments")
    ...
    save_json_results(results, "16_html_html", "retrieved_results")
