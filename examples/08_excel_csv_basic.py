...
def main() -> None:
    ...
    save_json_results(docs, "08_excel_csv_basic", "loaded_documents")

    print_section("2. Table Segmentation")
    splitter = CSVTableSplitter(max_rows_per_chunk=10, max_chunk_size=100)
    ...
    save_json_results(segments, "08_excel_csv_basic", "segments")
    ...
    print(f"Indexing {len(segments)} segment(s) into '08_excel_csv_basic'...")
    ...
    save_json_results(results, "08_excel_csv_basic", "retrieved_results")
